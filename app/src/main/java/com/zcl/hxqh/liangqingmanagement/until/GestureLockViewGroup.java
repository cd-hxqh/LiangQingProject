...
import com.zcl.hxqh.liangqingmanagement.until.GestureLockView.Mode;
...
public class GestureLockViewGroup extends RelativeLayout{
     ...
     */
    private int mNoFingerInnerCircleColor = 0xFFFFFF;
    /**
...
//    private int mFingerOnColor = 0xFF378FC9;
    private int mFingerOnColor = Color.parseColor("#41c378") ;
    /**
    ...
    public boolean onTouchEvent(MotionEvent event)
    {
        ...
        switch (action)
        {
            ...
            case MotionEvent.ACTION_MOVE:
                mPaint.setColor(getResources().getColor(R.color.blue_1));
//                mPaint.setAlpha(100);
