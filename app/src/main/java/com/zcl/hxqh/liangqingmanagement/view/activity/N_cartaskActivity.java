 ...
 * 车辆查询
 */
public class N_cartaskActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener, SwipeRefreshLayout.OnLoadListener {
    ...
    protected void initView() {
        ...
        layoutManager = new LinearLayoutManager(N_cartaskActivity.this);
    ...
    private void getData(String tagId) {
        HttpManager.getDataPagingInfo(N_cartaskActivity.this, HttpManager.getN_CARTASK(tagId, 1, 5), new HttpRequestHandler<Results>() {
                    @Override
                    ...
                    public void onSuccess(Results results, int totalPages, int currentPage) {
                        ArrayList<N_CARTASK> item = JsonUtils.parsingN_CARTASK(N_cartaskActivity.this, results.getResultlist());
                        refresh_layout.setRefreshing(false);
    ...
    private void initAdapter(final List<N_CARTASK> list) {
        n_cartaskListAdapter = new N_cartaskListAdapter(N_cartaskActivity.this, R.layout.list_item, list);
        ...
        n_cartaskListAdapter.setOnRecyclerViewItemClickListener(new BaseQuickAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(N_cartaskActivity.this, N_cartaskDetailsActivity.class);
