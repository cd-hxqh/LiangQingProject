...
public class Nfc_Activity extends BaseActivity {
    ...
    protected void findViewById() {
        ...
        tagContent = (LinearLayout) findViewById(R.id.list_id);
        tagText = (TextView) findViewById(R.id.tagid_id);
    }

    @Override
    protected void initView() {
        titleText.setText(R.string.nfc_text);
    ...
    private void resolveIntent(Intent intent) {
        ...
        if (NfcAdapter.ACTION_TAG_DISCOVERED.equals(action)
            ...
            if (tagId != null) {
                MessageUtils.showMiddleToast(Nfc_Activity.this, "扫描失败,请重新尝试");
            } else {
            ...
            if (type != null && type.equals("wiline")) {
                ...
                Intent bIntent = getIntent();
                bIntent.putExtra("tagId", tagId);
                bIntent.setClass(Nfc_Activity.this, N_cartaskListActivity.class);
                startActivityForResult(intent, 0);
            }
