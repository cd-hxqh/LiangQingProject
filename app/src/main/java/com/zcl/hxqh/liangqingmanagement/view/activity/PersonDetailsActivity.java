 ...
 * 人员查询
 */
public class PersonDetailsActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener, SwipeRefreshLayout.OnLoadListener {
    ...
    protected void findViewById() {
        ...
        displaynameTextView = (TextView) findViewById(R.id.person_name_id);
        n_idnumTextView = (TextView) findViewById(R.id.person_idnum_id);
        n_worktypeTextView = (TextView) findViewById(R.id.person_worktype_id);
        n_phoneTextView = (TextView) findViewById(R.id.person_phone_id);

        workText = (TextView) findViewById(R.id.work_history);
        attenceText = (TextView) findViewById(R.id.attence_history);
    ...
    private class MyOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (index == 0) {
                if (tagId.equals("")) {
                    MessageUtils.showMiddleToast(PersonDetailsActivity.this, "请扫描一卡通卡号");
                } else {
                    getLoadingDialog("正在获取数据").show();
                    getWTLABORData(tagId);
                }
    ...
    public void onRefresh() {
        if (tagId.equals("")) {
            MessageUtils.showErrorMessage(PersonDetailsActivity.this, "请先扫描卡号");
        } else {
            if (current == 0) {
                getWTLABORData(tagId);
            } else if (current == 1) {
    ...
    private void getPersonData(String n_cardnum) {
        HttpManager.getDataPagingInfo(PersonDetailsActivity.this, HttpManager.getPERSON(n_cardnum, 1, 5), new HttpRequestHandler<Results>() {
            @Override
            ...
            public void onSuccess(Results results, int totalPages, int currentPage) {
                ...
                if (item != null && item.size() == 1) {
                    ...
                    MessageUtils.showErrorMessage(PersonDetailsActivity.this, "此卡无相关记录");
                }
            }
    ...
    private void initwtlabor(View view) {
        ...
        layoutManager1 = new LinearLayoutManager(PersonDetailsActivity.this);
    ...
    private void initwtline(View view) {
        ...
        layoutManager2 = new LinearLayoutManager(PersonDetailsActivity.this);
    ...
    private void initWtlaborListAdapter(final List<WTLABOR> list) {
        wtlaborListAdapter = new WtlaborListAdapter(PersonDetailsActivity.this, R.layout.wtline_list_item, list);
        ...
        wtlaborListAdapter.setOnRecyclerViewItemClickListener(new BaseQuickAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(PersonDetailsActivity.this, WtlaborDetailsActivity.class);
    ...
    private void initwtlineAdapter(final List<N_WTLINE> list) {
        wtlineListAdapter = new WtlineListAdapter(PersonDetailsActivity.this, R.layout.wtline_list_item, list);
    ...
    private FlippingLoadingDialog getLoadingDialog(String msg) {
        if (mLoadingDialog == null)
            mLoadingDialog = new FlippingLoadingDialog(PersonDetailsActivity.this, msg);
    ...
    private void getWTLABORData(String cardnum) {
        HttpManager.getDataPagingInfo(PersonDetailsActivity.this, HttpManager.getWTLABOR(cardnum, 1, 5), new HttpRequestHandler<Results>() {
            @Override
            public void onSuccess(Results results) {
                Log.i(TAG, "data=" + results);
            }
            ...
            public void onSuccess(Results results, int totalPages, int currentPage) {
                ...
                ArrayList<WTLABOR> item = JsonUtils.parsingWTLABOR(PersonDetailsActivity.this, results.getResultlist());
    ...
    private void getN_WTLINEData(String n_cardnum) {
        HttpManager.getDataPagingInfo(PersonDetailsActivity.this, HttpManager.getN_WTLINE2(n_cardnum, 1, 5), new HttpRequestHandler<Results>() {
            @Override
            public void onSuccess(Results results) {
                Log.i(TAG, "data=" + results);
            }
            ...
            public void onSuccess(Results results, int totalPages, int currentPage) {
                mLoadingDialog.dismiss();
                ArrayList<N_WTLINE> item = JsonUtils.parsingN_WTLINE(PersonDetailsActivity.this, results.getResultlist());
                refresh_layout2.setRefreshing(false);
